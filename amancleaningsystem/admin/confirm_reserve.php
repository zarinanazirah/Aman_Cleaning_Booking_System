...
<body>
	...
	<div class = "container-fluid">	
		<ul class = "nav nav-pills">
			...
			<li class = "active"><a href = "reserve.php">Bookings</a></li>
	...
	<div class = "container-fluid">
		<div class = "panel panel-default">
			<div class = "panel-body">
				...
				<?php
					$query = $conn->query("SELECT * FROM `transaction` NATURAL JOIN `guest` NATURAL JOIN `services` WHERE `transaction_id` = '$_REQUEST[transaction_id]'") or die(mysqli_error());
				...
				<form method = "POST" enctype = "multipart/form-data" action = "save_form.php?transaction_id=<?php echo $fetch['transaction_id']?>">
					...
					<div class = "form-inline" style = "float:left;">
						...
						<br />
						<input type = "text" value = "<?php echo $fetch['services_type']?>" class = "form-control" size = "20" disabled = "disabled"/>
					</div>
					<div class = "form-inline" style = "float:left; margin-left:20px;">
						<label>Services No</label>
						<br />
						<input type = "number" min = "0" max = "999" name = "services_no" class = "form-control" required = "required"/>
					</div>
					<div class = "form-inline" style = "float:left; margin-left:20px;">
						<label>Days</label>
						<br />
